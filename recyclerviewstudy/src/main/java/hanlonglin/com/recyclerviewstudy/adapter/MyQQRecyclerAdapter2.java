...
public class MyQQRecyclerAdapter2 extends RecyclerView.Adapter implements ItemTouchMoveListener {
    private final StartDragListener startDragListener;
    List<QQMessage> list;

    public MyQQRecyclerAdapter2(List<QQMessage> list, StartDragListener startDragListener) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_qq2,parent,false);
